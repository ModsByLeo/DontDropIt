...
public class ModConfigGui {
    ...
    private static void addDropDelayCategory(ModConfig cfg, ConfigBuilder cb) {
        ...
        cDropDelay.addEntry(eb.startBooleanToggle(k("drop_delay.do_delay_once"), cfg.dropDelay.doDelayOnce)
    ...
    private static void addFavoritesCategory(ModConfig cfg, ConfigBuilder cb) {
        ...
        cFavorites.addEntry(eb.startBooleanToggle(k("favorites.enchantments.ignore_invalid_targets"), cfg.favorites.enchIgnoreInvalidTargets)
